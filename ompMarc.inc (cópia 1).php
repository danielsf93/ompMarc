...
$rec100a = '100' . '000000136';
$rec100b = '100' . '000000136';
$rec100c = '100' . '000000136';
$rec100d = '100' . '000000136';
$rec100e = '100' . '000000136';
$rec100f = '100' . '000000136';
...
$rec260Prefix = 'a ' . $cidade . 'b' . htmlspecialchars($copyright) . 'c' . htmlspecialchars($copyrightyear) .'  ';




// Obtendo o comprimento de $rec260Prefix e adicionando +3
$rec260PrefixLength = mb_strlen($rec260Prefix, 'UTF-8') + 3;

// Formatando para manter 4 dígitos
$rec260 = '260' . sprintf('%04d', $rec260PrefixLength + $rec260Value)  . sprintf('%05d', $rec260Value);
...
//numeracao
$marcContent .= $recPadrao . $rec100a . $rec100b . $rec100c .$rec100d .$rec100e .$rec100f .$rec245 . $rec260 . $rec500;
