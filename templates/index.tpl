	...
	<div id="exmlSettingsForm">
		...
		<a href="https://www.crossref.org/documentation/register-maintain-records/direct-deposit-xml/admin-tool/" target="_blank"> manual da Crossref </a>
			...
			<form class="pkp_form" id="exmlSettingsForm" method="post"
				...
				{fbvFormSection}
				{fbvElement type="text" id="email" value=$email label="email_address" maxlength="100" size=$fbvStyles.size.MEDIUM}
				{fbvElement type="text" id="username" value=$username label="depositor_name" maxlength="50" size=$fbvStyles.size.MEDIUM}
